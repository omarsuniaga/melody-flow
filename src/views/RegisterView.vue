      ...
      <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
        <form class="space-y-6" @submit.prevent="handleRegister">
          ...
          <div>
            ...
            />
            <p v-if="errors.fullName" id="fullName-error" class="mt-2 text-sm text-red-600">
              {{ errors.fullName }}
            </p>
          </div>
          ...
          <div>
            ...
            />
            <p v-if="errors.confirmPassword" id="confirmPassword-error" class="mt-2 text-sm text-red-600">
